<?php
 ...
 $materia = $_REQUEST['materia']; /*Captura todos los datos del formulario y los asigna a una variable*/
 ...
 $consulta = "INSERT INTO profes(login, clave, nombre, apellidos, email, materia) values ($login, $clave, '$nombre', '$apellidos', '$email', '$materia')";
