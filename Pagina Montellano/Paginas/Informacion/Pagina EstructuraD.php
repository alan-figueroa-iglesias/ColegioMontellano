...
<body>
	...
	<header class="header2">
		<div class="texto">
			<h2 class="titulo">Estructura Docente</h2>
		</div>
	...
	<main>
		<section class="acerca-de">
			<div class="contenedor">
				...
				<p class="parrafo">
					Castañeda Garcia Mariano <br>
					De la Cruz Santana Pedro <br>
					Espinoza Jiménez Francisco <br>
					Garcia Vázquez Jesús Fernando <br>
					Hernández Nava Claudia Isela <br>
					Hernández Ramírez Armando <br>
					Hernández Solis Martha Patricia <br>
					Jiménez Ochoa Samuel <br>
					Martínez Benitez Nélida María <br>
					Mendoza Barajas Oscar Gustavo <br>
					Moreno Chavez Jorge Alberto <br>
					Navarro Alcaraz Maribel <br>
					Ochoa Torres Daniel <br>
					Ordoñez Ayala Angel <br>
					Pérez Verduzco Ma. Guadalupe <br>
					Pérez Martínez Fernando <br>
					Pimentel Alcaraz Saida Jeanette <br>
					Ponce Suárez Hugo César <br>
					Quiles Medina Carmen Elisa <br>
					Ramírez Hernández Rafael <br>
					Reyes Solano Luis <br>
					Rivera González Ana Cecilia <br>
					Ruiz Rivera Adriana <br>
					Ruiz Sánchez Maria Isabel <br>
					Tetlalmatzi Hernández Amado Lino <br>
					Vázquez Granados Guadalupe <br>
					Ventura Gutiérrez Rosa María <br>
					Ventura Santana Nidia <br>
					Barragán Garcia Cristina <br>
					Fabiola Arreola Cabrera <br>
				</p>
