...
<body>
	...
	<header class="header2">
		<div class="texto">
			<h2 class="titulo">Estructura Administrativa</h2>
		</div>
	...
	<main>
		<section class="acerca-de">
			<div class="contenedor">
				<h2 class="sobre-nosotros">Nuestra Estructura Administrativa</h2><br>
				<h3 class="slogan">
					Director: Jorge García Pérez <br>
					Contadora: Patricia Minerva Nava Cárdenas  <br>
					Asesora Pedagógica: Raquel Adilene Serrano Rodríguez  <br>
					Encargada de becas: Norma Guadalupe Mesina Manzo  <br>
					Secretaria: Maricruz Vázquez Viera  <br>
					Secretaria: Fernanda Eusebio Jiménez  <br>
					Secretaria: Jeannete Alejandrina Rodríguez Cano  <br>
				</h3>
