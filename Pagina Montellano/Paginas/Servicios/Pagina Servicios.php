	...
	<main>
		<section class="acerca-de">
			<div class="contenedor">
				<h2 class="sobre-nosotros">Algunos de nuestros servicios</h2><br>
				<p class="parrafo">
					•	Bebederos. <br>
					•	Comedores equipados. <br>
					•	Patio cívico o central: para eventos o ceremonias. <br>
					•	Canchas: espacio para juegos deportivos con canchas de futbol y basquetbol. <br>
					•	Sala de Medios Audiovisuales: Sala insonorizada y equipada para charlas, conferencias y reuniones de grupo. <br>
				</p>
