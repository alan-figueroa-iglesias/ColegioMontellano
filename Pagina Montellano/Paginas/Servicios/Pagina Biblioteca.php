	...
	<main>
		<section class="acerca-de">
			<div class="contenedor">
				<h2 class="sobre-nosotros">El colegio cuenta con una biblioteca, para servicios de consulta y préstamos de libros para los alumnos y los padres de familia. </h2>
		...
		<section class="miembros">
			<div class="contenedor">
				<div class="cards">
					...
					<div class="card">
						<img src="../../Imagenes/Principal/Libro.jpg" alt="">
						
					</div>

					<div class="card">
						<img src="../../Imagenes/Principal/Libro2.jpg" alt="">
						
					</div>

					<div class="card">
						<img src="../../Imagenes/Principal/Libro3.jpg" alt="">
