	...
	<main>
		<section class="acerca-de">
			<div class="contenedor">
				<h2 class="sobre-nosotros">EL colegio cuenta con 2 sanitarios, uno de hombre y uno de mujeres, cada sanitario tiene 5 baños, 5 lavamanos y 3 regaderas en cada uno.</h2>
		...
		<section class="miembros">
			<div class="contenedor">
				<div class="cards">
					...
					<div class="card">
						<img src="../../Imagenes/Principal/bano.jpg" alt="">
						
					</div>

					<div class="card">
						<img src="../../Imagenes/Principal/bano2.jpg" alt="">
					
					</div>

					<div class="card">
						<img src="../../Imagenes/Principal/bano3.jpg" alt="">
