	...
	<main>
		<section class="acerca-de">
			<div class="contenedor">
				<h2 class="sobre-nosotros">Ven y conoce nuestras cafeterías</h2>
		...
		<section class="miembros">
			<div class="contenedor">
				<div class="cards">
					...
					<div class="card">
						<img src="../../Imagenes/Principal/Cafe.jpg" alt="">
					
					</div>

					<div class="card">
						<img src="../../Imagenes/Principal/Cafe2.jpg" alt="">
						
					</div>

					<div class="card">
						<img src="../../Imagenes/Principal/Cafe3.jpg" alt="">
