	...
	<main>
		<section class="acerca-de">
			<div class="contenedor">
				<h2 class="sobre-nosotros">El colegio cuenta con selección de fútbol soccer y de baloncesto. En las intalaciones de la primaria se encuentran dos canchas, en las cuales se imparte la clase de educación física y entrenan los alumnos de la selección.</h2>
		...
		<section class="miembros">
			<div class="contenedor">
				<div class="cards">
					...
					<div class="card">
						<img src="../../Imagenes/Principal/Cancha.jpg" alt="">
						
					</div>

					<div class="card">
						<img src="../../Imagenes/Principal/Cancha2.jpg" alt="">
						
					</div>

					<div class="card">
						<img src="../../Imagenes/Principal/Cancha3.jpg" alt="">
