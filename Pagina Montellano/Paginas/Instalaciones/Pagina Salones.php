	...
	<main>
		<section class="acerca-de">
			<div class="contenedor">
				<h2 class="sobre-nosotros">Instalaciones</h2>
				<p class="parrafo">
					El colegio cuenta con 10 salones. Los alumnos disponen de salones normales, de artes, computación, dos canchas y un amplio patio de juego. Todas las aulas están equipadas con pizarras digitales interactivas y equipo de sonido. Además de estas clases, contamos con varias salones de apoyo que nos permiten trabajar con asesorías, para mejorar el rendimiento en asignaturas como inglés, matemáticas, o computación.
				</p>
		...
		<section class="miembros">
			<div class="contenedor">
				<div class="cards">
					...
					<div class="card">
						<img src="../../Imagenes/Principal/Salon.jpg" alt="">
					
					</div>

					<div class="card">
						<img src="../../Imagenes/Principal/Salon2.jpg" alt="">
						
					</div>

					<div class="card">
						<img src="../../Imagenes/Principal/Salon3.jpg" alt="">
