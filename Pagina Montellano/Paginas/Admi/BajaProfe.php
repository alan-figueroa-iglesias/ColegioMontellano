...
<body>
	...
	<section class="contenedor">
			<div class="titulo">
				<h2>Baja<span> Profesor</span></h2>
			</div>		
			<form class="formulario" action="../../PHP/BajaDocente.php" method="post">
				<input class="input" type="text" name="login" placeholder="Login de docente" required autofocus>
