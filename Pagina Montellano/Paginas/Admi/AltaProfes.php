...
<body>
	...
	<section class="contenedor">
			<div class="titulo">
				<h2>Alta <span>Profesor</span></h2>
			</div>		
			<form class="formulario" action="../../PHP/AltaProfes.php" method="post">
	            ...
	            <input class="input" type="text" name="materia" placeholder="Materia" required>
	            <div class="btn_form">
