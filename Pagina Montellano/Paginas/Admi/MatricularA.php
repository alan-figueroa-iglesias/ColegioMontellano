...
<body>
	...
	<section class="contenedor">
			<div class="titulo">
				<h2>Matricular <span>Usuario</span></h2>
			</div>		
			<form class="formulario" action="../../PHP/MatriculacionA.php" method="post">
	            ...
	            <input class="input" type="text" name="asignatura" placeholder="Asignatura" required>
