...
<body>
	...
	<section class="contenedor">
			<div class="titulo">
				<h2>Alta <span>Asignatura</span></h2>
			</div>		
			<form class="formulario" action="../../PHP/AltaAsignaturas.php" method="post">
				<input class="input" type="text" name="asignatura" placeholder="Asignatura" required autofocus>
	            <input class="input" type="number" name="nivel" placeholder="Nivel de la asignatura " required>
	            <input class="input" type="text" name="profesor" placeholder="Profesor que la imparte" required>
