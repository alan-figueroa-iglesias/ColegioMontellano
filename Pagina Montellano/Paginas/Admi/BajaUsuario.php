...
<body>
	...
	<section class="contenedor">
			<div class="titulo">
				<h2>Baja<span> Alumno</span></h2>
			</div>		
			<form class="formulario" action="../../PHP/BajaUsuario.php" method="post">
				<input class="input" type="text" name="login" placeholder="Login de alumno" required autofocus>
