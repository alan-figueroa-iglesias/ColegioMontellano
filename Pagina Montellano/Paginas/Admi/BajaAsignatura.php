...
<body>
	...
	<section class="contenedor">
			<div class="titulo">
				<h2>Baja<span> Asignatura</span></h2>
			</div>		
			<form class="formulario" action="../../PHP/BajaAsignatura.php" method="post">
				<input class="input" type="text" name="asignatura" placeholder="Nombre de la asignatura" required autofocus>
	             
	            <div class="btn_form">
	            	<input class="btn" type="submit" value="DAR DE BAJA">   	
	            </div>
			</form>
	</section>
	<footer>
