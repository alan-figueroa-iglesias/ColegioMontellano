...
<body>
		...
		<nav class="menu">
			<ul>
				...
				<li class="submenu"><a href="#"><span class="cuatro"><i class="icon icon-user-minus"></i></span>Bajas<span class="flecha"><i class="icon icon-circle-down"></i></span></a>
					<ul class="subs">
						<li><a href="BajaUsuario.php">Baja de Usuario</a></li>
	...
	<section class="contenedor">
			<div class="titulo">
				<h2>Búsqueda <span>Usuario</span></h2>
			</div>		
			<form class="formulario" action="../../PHP/BusquedaUsuario.php" method="post">
				<input class="input" type="number" name="login" placeholder="Login del usuario" required autofocus>
	            <div class="btn_form">
